<x-app-layout>
    ...
    {{-- 
      ...
      Centra todo el contenido y añade padding horizontal (px-4) 
      y espacio vertical (py-8) 
    --}}
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="w-full overflow-hidden rounded-lg mb-10">
            <img src="{{ asset('/LoNuevo.png')}}" alt="Banner de Lo Nuevo" class="w-full h-auto object-cover">
        </div>
