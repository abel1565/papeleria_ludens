<x-app-layout>
    ...
    <h1 class="text-2xl font-semibold text-gray-700 mb-4">Resultados para: "{{ $subcategoria->subcategoria }}"</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        @foreach ($subcategoria->productos as $producto)
            ...
            <div class="col-span-full text-center py-12 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-sm">
                ...
                @if($subcategoria!)
                    <p class="text-gray-500 dark:text-gray-400 mt-2">No hay articulos disponibles</p>
                @endif
            </div>
        @endforeach
