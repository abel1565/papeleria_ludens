...
<div class="w-64 h-screen bg-blue-900 text-white flex flex-col shadow-lg">
    ...
    <nav class="flex-1 px-4 py-6 space-y-6 overflow-y-auto">
        ...
        <!-- Usuarios -->
        <div>
            <h3 class="text-sm font-semibold text-white uppercase mb-2">Usuarios</h3>
            <ul class="space-y-2">
                <li>
                ...
                <li>
                    <a href="{{route('admin.registrer')}}" class="flex items-center space-x-2 p-2 rounded hover:bg-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4v16m8-8H4"/>
                        </svg>
